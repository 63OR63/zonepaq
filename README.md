...
- If you encounter any errors after changing settings, you can reset them to default by deleting the [code]settings.ini[/code] file located in the same folder as the app.
- If you get some bug, please include latest logs from [code]logs/zonepaq.log[/code] file in your report.
