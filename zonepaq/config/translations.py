TRANSLATIONS = {
    "English": {
        ...
        "dialogue_relaunch": "All setting will reset to the default values, relaunching the app.",
        ...
        "tooltip_button_restart": "Restart the app",
    ...
    "Русский": {
        ...
        "dialogue_relaunch": "Настройки будут сброшены до значений по умолчанию, а приложение перезапущено.",
        ...
        "tooltip_button_restart": "Перезапустить приложение",
        "tooltip_button_unpack": "Распаковать файлы в папку назначения",
        "tooltip_button_repack": "Запаковать папки в папку назначения",
